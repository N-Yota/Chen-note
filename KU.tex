...
\begin{equation}
  \boxed{\omega^2 = \omega^2_p + c^2k^2} \label{4.94}
\end{equation}
...
\begin{equation}
  \boxed{\frac{c^2k^2}{\omega^2} = \frac{c^2}{v^2_\phi} = 1 - \frac{\omega^2_p}{\omega^2}\frac{\omega^2 - \omega^2_p}{\omega^2 - \omega^2_h}} \label{4.104}
\end{equation}
